...
public class PlayerMovementController : MonoBehaviour
{
    ...
    private float m_Speed=21.0f;
    private float m_FastSpeedMultiplier = 1.55f;
    private float m_JumpSpeed = 7f;
    private float m_VerticalSpeed = 0f;
    private bool m_OnGround;
    [SerializeField] private MarioAnimController animatorController;
    ...
    private void UpdateAnimations()
    {
        ...
        {
            Debug.LogError("Animator not set in " +this, gameObject);
            return;
        }

        animatorController.horizontalSpeed = new Vector2(m_CharacterController.velocity.x, m_CharacterController.velocity.z).magnitude;
    }
}
